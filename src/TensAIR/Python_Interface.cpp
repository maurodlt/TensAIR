...
PYBIND11_MODULE(tensair_py, m) {
    ...
    py::class_<word_embedding::EventGenerator, BasicVertex<>, Vertex>(m, "W2V_EventGenerator")
        ...
        }), py::arg("mpi_comm"), py::arg("tag"), py::arg("mini_batch_size"), py::arg("msg_sec") = 1000, py::arg("epochs")=5, py::arg("train_data_file"), py::arg("window_size")=1000000);
    ...
    py::class_<event_generator::EventGenerator, BasicVertex<>, Vertex>(m, "UDF_EventGenerator")
        ...
        }), py::arg("mpi_comm"), py::arg("tag"), py::arg("mini_batch_size"), py::arg("msg_sec") = 1000, py::arg("window_size")=1000000, py::arg("init_code")="");
    ...
    py::class_<concept_drift_cifar::EventGenerator, BasicVertex<>, Vertex>(m, "Fixed_EventGenerator")
        ...
        }), py::arg("mpi_comm"), py::arg("tag"), py::arg("mini_batch_size"), py::arg("msg_sec") = 1000, py::arg("epochs")=5, py::arg("train_data_file"), py::arg("window_size")=1000000, py::arg("drift_frequency")=10);
    ...
    py::class_<TensAIR, BasicVertex<>, Vertex>(m, "TensAIR")
        ...
        }), py::arg("mpi_comm"), py::arg("tag"), py::arg("window_size"), py::arg("broadcast_frequency")=1, py::arg("epochs")=5, py::arg("gpus_per_node") = 0, py::arg("saved_model_dir"), py::arg("eval_data_file"), py::arg("tags") = "serve", py::arg("epoch_size") = 1000, py::arg("convergence_factor") = 1e-2, py::arg("epochs_for_convergence") = 2, py::arg("drift_detector_mode") = 0, py::arg("print_to_folder"), py::arg("print_frequency") = 1, py::arg("preallocate_tensors") = false, py::arg("mini_batch_size") = 0)
